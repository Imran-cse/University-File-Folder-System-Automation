<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SDP_Project.WebForm1" %>
...
<body>
    ...
    ================================================== -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button runat="server" ID="loginButton" CssClass="btn btn-primary pull-left" Text="Login" OnClick="loginButton_Click" />
                        <asp:Button runat="server" ID="adminButton" CssClass="btn btn-primary" Text="Admin Login" OnClick="adminButton_Click" />
        ...
        <div style="height:500px">
            <p class="text-center">Welcome to the official working site of Khulna University</p>
            <p class="text-center">Please Login to get Access</p>
