<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostManagement.aspx.cs" Inherits="SDP_Project.PostManagement" %>
...
<body>
    ...
    ================================================== -->
        ...
        <div class="container">
            ...
            <br />
            <br />
            <p><a class="btn btn-lg btn-primary" href="#" role="button" data-target="#postAddModal" data-toggle="modal">Add Post</a></p>
        </div>
         <div class="modal fade" id="postAddModal" data-backdrop="static" tabindex="-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox  runat="server" class="form-control" ID="inputName" placeholder="Enter Post Name" />
                        </div>           
                    </div>
